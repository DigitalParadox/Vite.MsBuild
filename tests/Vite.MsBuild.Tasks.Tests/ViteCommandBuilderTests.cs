...
namespace Vite.MsBuild.Tasks.Tests
{
    public class ViteCommandBuilderTests : IDisposable
    {
        ...
        {
            // Arrange
            var builder = new ViteCommandBuilder(_tempDir, PackageManager.Npm)
            ...
            PackageManager packageManager, string expectedExecutable, string expectedCommand)
        {
            // Arrange
            CreatePackageJson(new Dictionary<string, string> { ["build"] = "vite build" });
            var builder = new ViteCommandBuilder(_tempDir, packageManager);
        ...
        public void Should_Handle_Yarn_Berry_Correctly()
        {
            ...
            var builder = new ViteCommandBuilder(_tempDir, PackageManager.Yarn);
        ...
        public void Should_Set_Environment_Variables()
        {
            ...
            var builder = new ViteCommandBuilder(_tempDir, PackageManager.Npm)
                ...
                .WithEnvironmentVariable("VITE_API_URL", "https://api.example.com");
