    ...
    public class FactoryCommandTypeDetectionTests : IDisposable
    {
        ...
        public void Should_Detect_Custom_Command_Type_When_Specified()
        {
            ...
            var command = new ViteCommandBuilder(projectDir, PackageManager.Npm)
                .WithCustomCommand("npm run custom-script")  // Use literal command
                .BuildCommand();
        ...
        public void Should_Handle_Scripts_Section_With_No_Build_Script()
        {
            ...
            var command = new ViteCommandBuilder(projectDir, PackageManager.Bun).BuildCommand();
        ...
        public void Should_Handle_Package_Manager_Specific_Behavior_In_Detection()
        {
            ...
            var npmCommand = new ViteCommandBuilder(projectDir, PackageManager.Npm).BuildCommand();
            var yarnCommand = new ViteCommandBuilder(projectDir, PackageManager.Yarn).BuildCommand();
            var pnpmCommand = new ViteCommandBuilder(projectDir, PackageManager.Pnpm).BuildCommand();
            var bunCommand = new ViteCommandBuilder(projectDir, PackageManager.Bun).BuildCommand();
        ...
        public void Should_Detect_Command_Type_Priority_Order()
        {
            ...
            var scriptCommand = new ViteCommandBuilder(projectDir, PackageManager.Npm).BuildCommand();
            ...
            var directCommand = new ViteCommandBuilder(projectWithoutScripts, PackageManager.Npm).BuildCommand();
        ...
        public void Should_Validate_Factory_Creates_Correct_Builder_Types()
        {
            ...
            var scriptCommand = new ViteCommandBuilder(projectWithScript, PackageManager.Npm).BuildCommand();
            scriptCommand.ToString().Should().Contain("npm run build");
            
            // Direct tool behavior (should use direct vite execution)
            var directCommand = new ViteCommandBuilder(projectWithoutScript, PackageManager.Npm).BuildCommand();
            directCommand.ToString().Should().Contain("npx vite build");
            
            // Custom command behavior (literal execution)
            var customCommand = new ViteCommandBuilder(projectWithScript, PackageManager.Npm)
                .WithCustomCommand("npm run my-custom-build")  // Use literal command
                .BuildCommand();
        ...
        public void Should_Throw_For_Invalid_Custom_Commands(string invalidCustomCommand)
        {
            ...
            var builder = new ViteCommandBuilder(projectDir, PackageManager.Npm)
                .WithCustomCommand(invalidCustomCommand);
