...
namespace Vite.MsBuild.PureUnitTests
{
    ...
    public class MSBuildPropertyUsageTests : IDisposable
    {
        ...
        public void Should_Support_Complex_Property_Combinations()
        {
            ...
            var command = new ViteCommandBuilder(_tempDirectory, PackageManager.Npm)
                .WithCustomCommand(complexCommand)
                .BuildCommand();
        ...
        public void Should_Support_Environment_Specific_Paths()
        {
            ...
            var devCommand = new ViteCommandBuilder(_tempDirectory, PackageManager.Npm)
                .WithCustomCommand(devScript)
                .BuildCommand();
                
            var prodCommand = new ViteCommandBuilder(_tempDirectory, PackageManager.Npm)
                .WithCustomCommand(prodScript)
                .BuildCommand();
        ...
        public void Should_Handle_Quoted_Paths_With_Spaces()
        {
            ...
            var command = new ViteCommandBuilder(_tempDirectory, PackageManager.Npm)
                .WithCustomCommand(quotedCommand)
                .BuildCommand();
