...
{
    public class ResolveViteConfigDependenciesTests
    {
        [Fact]
        public void Execute_WithNoDependencies_ReturnsConfigsInOriginalOrder()
        {
            // Arrange
            var task = new ResolveViteConfigDependencies
            {
        ...
        [Fact]
        public void Execute_WithMissingBuildId_LogsErrorAndContinues()
        {
            // Arrange
            var mockEngine = new Helpers.MockBuildEngine();
            ...
            // Assert
            result.Should().BeTrue(); // Should continue despite error
