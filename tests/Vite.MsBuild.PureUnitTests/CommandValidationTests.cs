...
namespace Vite.MsBuild.PureUnitTests
{
    ...
    public class CommandValidationTests : IDisposable
    {
        ...
        public void Should_Build_Complete_Command_With_All_Options()
        {
            ...
            var command = new ViteCommandBuilder(projectDir, PackageManager.Pnpm)
                .WithConfig("vite.admin.config.ts")
                .WithMode("production")
                .WithOutputDir("dist/admin")
                .WithLogLevel("silent")
                .WithColors(false)
        ...
        public void Should_Support_Multi_SPA_Configuration()
        {
            ...
            var adminCommand = new ViteCommandBuilder(projectDir, PackageManager.Npm)
                .WithConfig("Areas/Admin/vite.admin.config.ts")
                .WithMode("development")
                .WithOutputDir("wwwroot/admin")
                .Build();

            var customerCommand = new ViteCommandBuilder(projectDir, PackageManager.Npm)
        ...
        public void Should_Support_Command_Priority_Hierarchy()
        {
            ...
            var customCommand = new ViteCommandBuilder(projectDir, PackageManager.Npm)
                .WithCustomCommand("yarn build:special")
                .Build();
            ...
            var fallbackCommand = new ViteCommandBuilder(projectDir, PackageManager.Npm)
                .Build();
