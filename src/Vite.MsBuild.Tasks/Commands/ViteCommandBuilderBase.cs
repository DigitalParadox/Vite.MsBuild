...
namespace Vite.MsBuild.Tasks
{
    ...
    /// ✅ Uses environment variables for colors (FORCE_COLOR/NO_COLOR) - Vite doesn't support --color flags!
    /// ✅ Implements proper package manager behavior (Yarn direct execution vs npm scripts)
    /// ✅ Follows Node.js ecosystem standards for cross-platform compatibility
    ...
    public abstract class ViteCommandBuilderBase : IViteCommandBuilder
    {
        ...
        protected Dictionary<string, string> Environment = new();
