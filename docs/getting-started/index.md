...
Get up and running with ViteKit.Msbuild in your ASP.NET Core project quickly.
{: .fs-6 .fw-300 }
...
Follow these steps to get ViteKit.Msbuild working in your project:
...
- **[Architecture](../architecture/)** - Understand how ViteKit.Msbuild works internally